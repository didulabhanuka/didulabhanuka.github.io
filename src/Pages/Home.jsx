...
const SOCIAL_LINKS = [
  ...
  { icon: Instagram, link: "https://www.instagram.com/bh.anuka" },
];
...
const Home = () => {
  ...
  return (
    <section id="Home" className="bg-[#030014] overflow-hidden px-[5%] lg:px-[10%] pt-10 sm:pt-12 pb-10 sm:pb-16">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="max-w-7xl w-full mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-12">
            ...
            <div
              className="hidden lg:flex w-full lg:w-1/2 h-auto lg:h-[600px] xl:h-[750px] relative items-center justify-center order-2"
      ...
      {/* Local keyframes to support utility classes used in this component */}
      <style jsx>{`
